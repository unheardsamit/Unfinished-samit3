...
const nix = ["হুম বলো,আমি শুনছি😀"এখন ডাকিও না,আমি একটু ব্যাস্ত আছি""হুম আমিই আলিয়া বলো কিভাবে সাহায্য করতে পারি"];
const ok = ["shahriar", "আহনাফ", "Exe", "সামিত", "Ahnaf", "Samit", "Alia"];

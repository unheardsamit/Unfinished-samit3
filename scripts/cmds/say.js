...
module.exports = {
  ...
  onStart: async function ({ api, event, args, getLang }) {
    try {
      ...
      const supportedLanguages = ["bn", "en", "ko", "ja", "tl", "vi", "in", "ne"];
      const defaultLanguage = "bn"; // Set the default language to "en"
      ...
      const url = `https://translate.google.com/translate_tts?ie=UTF-8&q=${encodeURIComponent(msg)}&tl=bn&client=tw-ob`;
